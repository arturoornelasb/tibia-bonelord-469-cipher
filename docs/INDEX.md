...
### Research Papers
- [Cracking the Bonelord 469 Cipher](../papers/469_cipher/paper_469_cipher.md) — Full research paper: methodology, evidence, and results
- [Bag-of-Letters Word Partition (BoLWP)](../papers/bag_of_letters/paper_bag_of_letters.md) — Novel cryptanalytic technique for garbled block recovery
...
- [Descifrando la Cifra Bonelord 469](../papers/469_cipher/paper_469_cipher.es.md) — Artículo de investigación completo: metodología, evidencia y resultados
- [Partición de Bolsa de Letras (BoLWP)](../papers/bag_of_letters/paper_bag_of_letters.es.md) — Técnica criptoanalítica novedosa para recuperación de bloques ilegibles
