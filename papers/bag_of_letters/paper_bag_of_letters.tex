...
\begin{itemize}
\item E (16.4\% frequency) $\rightarrow$ 20 codes
\item N (9.8\%) $\rightarrow$ 10 codes
\item I (7.6\%) $\rightarrow$ 8 codes
\item S (7.3\%) $\rightarrow$ 7 codes
\item \ldots down to V (0.7\%) $\rightarrow$ 1 code
\end{itemize}
...
DIE|RALT|STEIN|E|IST|EIN|RUIN  $\rightarrow$  suboptimal
DIE|R|ALTE|STEIN|E|IST|EIN|RUIN  $\rightarrow$  better
\end{lstlisting}
...
The I$\rightarrow$E swap dominates (87\% of all swaps), consistent with E being the most frequent letter (20 codes) creating the most boundary ambiguity.
