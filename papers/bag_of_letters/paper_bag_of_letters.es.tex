...
\author{Proyecto de Investigación Independiente}
\date{Marzo 2026\\[0.5em]\normalsize Licencia: BUSL-1.1 (ver LICENSE en la raíz del repositorio)}
...
\begin{itemize}
\item E (16,4\% de frecuencia) $ightarrow$ 20 códigos
\item N (9,8\%) $ightarrow$ 10 códigos
\item I (7,6\%) $ightarrow$ 8 códigos
\item S (7,3\%) $ightarrow$ 7 códigos
\item ...hasta V (0,7\%) $ightarrow$ 1 código
\end{itemize}
...
\begin{itemize}
\item OEDE (4 letras, ``páramo'') --- requiere 2 intercambios I$ightarrow$E
...
\begin{itemize}
\item \texttt{WINDUNRUH} $ightarrow$ \texttt{WINDNURH} (rompe el compuesto ``Windunruh'' = viento-inquietud)
\item \texttt{SCHAUNRUIN} $ightarrow$ \texttt{SCHAUNRUIN} (rompe ``schaun ruin'' = contemplar ruina)
\end{itemize}
...
Esto resolvió las 8 ocurrencias del anagrama UNR$ightarrow$NUR sin afectar las 4 ocurrencias de WINDUNRUH.
...
\begin{tabular}{lccc}
\toprule
\textbf{Ronda} & \textbf{Bloques Resueltos} & \textbf{Caracteres Recuperados} & \textbf{Tamaño Promedio de Bloque} \\
\midrule
...
El intercambio I$ightarrow$E domina (87\% de todos los intercambios), consistente con que E es la letra más frecuente (20 códigos) creando la mayor ambigüedad en los límites.
...
\vfill
\begin{center}
\textit{Este trabajo está licenciado bajo BUSL-1.1. Gratuito para individuos, académicos y organizaciones sin fines de lucro. El uso comercial requiere un acuerdo de participación. Ver LICENSE y COMMERCIAL.md en la raíz del repositorio.}
\end{center}
