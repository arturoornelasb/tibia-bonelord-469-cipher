"""
Tier 11: 87 codes. Tier 9 (83) + 4 differential word-test assignments.
Added: 25=O (ORT/ORTE/ORTEN:3 each), 83=V (VIEL:+2, fills V deficit),
       81=T (IST:+8), 24=I (TEIL:+8, flagged: I over-represented)
"""
import json
...
all_codes = {
    ...
    '25': 'O',  # ORT:3, ORTE:3, ORTEN:3 (score=36)
    '83': 'V',  # VIEL:+2 (score=16), V from 0%
    '81': 'T',  # IST:+8 (score=24)
    '24': 'I',  # TEIL:+8 (score=32) — FLAGGED: I already +2.7% over
}
...
print("=" * 70)
print(f"TIER 11 DECODER: {len(all_codes)} codes")
print("=" * 70)
...
for idx, decoded, length in book_decoded[:20]:
...
german_words = [
    ...
    'ORT', 'ORTE', 'ORTEN',
    'VIEL', 'VIELE', 'VIELEN',
    'VERSTECKT', 'VERBORGEN', 'VERBUNDEN',
    'GEBOREN', 'GERUFEN', 'GESCHAFFEN',
